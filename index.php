        ...
        <div class="container">
            <div class="header-main-wrapper">
                <div class="navbar-heade">
                    <div class="logo pull-left"><a href="index.php" class="header-logo "><img src="images/logo.png" alt=""/></a></div>
                    <button type="button" data-toggle="collapse" data-target=".navigation" class="navbar-toggle edugate-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
                </div>
                <nav class="navigation collapse navbar-collapse pull-right">
                    <ul class="nav-links nav navbar-nav">
                        <li class="dropdown active"><a href="index.php" class="main-menu">Home</a>
                        </li>
                        <li class="dropdown "><a href="about_us.php" class="main-menu">About Us</a>
                        </li>
            ...
            <div class="content">
                        ...
                        <div class="slider-1">
                            <div class="slider-caption">
                                <div class="container">
                                    ...
                                    <h1 class="text-info-1 text-white">You can learn anything</h1>
                        ...
                        <div class="slider-2">
                            <div class="slider-caption">
                                <div class="container">
                                    ...
                                    <h1 class="text-info-1 text-white">Education is life itself</h1>
                ...
                <div class="section section-padding intro-edu">
                    <div class="container">
                        <div class="intro-edu-wrapper">
                            <div class="row">
                                <div class="intro-title"> <b class="theme-color">Shree</b> <b> Commerce Classes</b></div>
                                <div class="intro-content"><p>Every moment in life is a fresh beginning. That brings with it the boundless joy of new possibilities. And the pleasure is compounded when you know, you are about to realize a lofty goal. Shree Commerce Classes is one of the premier educational institutes in Vikhroli & Dombivli. The journey started in 1996 and continues, aspiring to lead students reach their career goals in various fields of Commerce.</p>
                                <button onclick="window.location.href='about_us.php'" class="btn btn-green-2"><span>Read More</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section why-choose-us">
                    <div class="why-choose-us-wrapper-top">
                        <div class="container">
                            <div class="why-choose-us-wrapper"><h2 class="title-2">Why Shree Commerce Classes?</h2>
                        ...
                        <div class="container">
                            <div data-wow-delay="0.4s" data-wow-duration="1s" class="row why-choose-us-wrapper wow zoomIn">
                                <div class="customs-row">
                                    <div class="col-sm-4 col-xs-6 section-icon"><i class="fa fa-users"></i>

                                        <p> Limited Students Per Batch</p></div>
                                    <div class="col-sm-4 col-xs-6 section-icon"><i class="fa fa-money-bill"></i>

                                        <p> Reasonable Fees </p></div>
                                </div>
                                <div class="customs-row">
                                    <div class="col-sm-4 col-xs-6 section-icon"><i class="fa fa-pencil-ruler"></i>

                                        <p> Printed study material</p>
                                    </div>
                ...
                <div class="section section-padding choose-course-2">
                    <div class="container">
                        <div class="group-title-index">
                            ...
                            <h2 class="center-title">FEATURES</h2>
                        ...
                        <div class="choose-course-wrapper row">
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course">
                                    <div class="icon-course"><i class="icons-img fas fa-male"></i></div>
                                    <div class="info-course">
                                        <div class="name-course">Personal Attention</div>
                                    </div>
                                    <div class="hover-text">
                                        <div class="wrapper-hover-text">
                                            <div class="wrapper-hover-content">
                                                <div class="icon-course">
                                                    <i class="icons-img fas fa-male text-white"></i>
                                                </div>
                                                <div class="info-course">
                                                    <div class="name-course text-white">Personal Attention</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course">
                                    <div class="icon-course"><i class="icons-img fas fa-chalkboard-teacher"></i></div>
                                    <div class="info-course">
                                        <div class="name-course">Expert Teachers</div>
                                    </div>
                                    <div class="hover-text">
                                        <div class="wrapper-hover-text">
                                            <div class="wrapper-hover-content">
                                                <div class="icon-course"><i class="icons-img fas fa-chalkboard-teacher text-white"></i></div>
                                                <div class="info-course">
                                                    <div class="name-course text-white">Expert Teachers</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course">
                                    <div class="icon-course"><i class="icons-img fas fa-chalkboard"></i></div>
                                    <div class="info-course">
                                        <div class="name-course">Method of Teaching</div>
                                    </div>
                                    <div class="hover-text">
                                        <div class="wrapper-hover-text">
                                            <div class="wrapper-hover-content">
                                                <div class="icon-course"><i class="icons-img fas fa-chalkboard text-white"></i></div>
                                                <div class="info-course">
                                                    <div class="name-course text-white">Method of Teaching</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course">
                                    <div class="icon-course"><i class="icons-img fas fa-book-reader"></i></div>
                                    <div class="info-course">
                                        <div class="name-course">Revision</div>
                                    </div>
                                    <div class="hover-text">
                                        <div class="wrapper-hover-text">
                                            <div class="wrapper-hover-content">
                                                <div class="icon-course"><i class="icons-img fas fa-book-reader text-white"></i></div>
                                                <div class="info-course">
                                                    <div class="name-course text-white">Revision</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course">
                                    <div class="icon-course"><i class="icons-img fas fa-notes-medical"></i></div>
                                    <div class="info-course">
                                        <div class="name-course">Regular Exam</div>
                                    </div>
                                    <div class="hover-text">
                                        <div class="wrapper-hover-text">
                                            <div class="wrapper-hover-content">
                                                <div class="icon-course"><i class="icons-img fas fa-notes-medical text-white"></i></div>
                                                <div class="info-course">
                                                    <div class="name-course text-white">Regular Exam</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course">
                                    ...
                                    <div class="info-course">
                                        <div class="name-course">COUNSELLING</div>
                                    </div>
                                    <div class="hover-text">
                                        <div class="wrapper-hover-text">
                                            <div class="wrapper-hover-content">
                                                <div class="icon-course"><i class="icons-img icon-chat_bubbles text-white"></i></div>
                                                <div class="info-course">
                                                    <div class="name-course text-white">COUNSELLING</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="container">
                        <div id="people-talk" data-ride="carousel" data-interval="5000" class="slider-talk-about-us-wrapper carousel slide">
                            <div role="listbox" class="slider-talk-about-us-content carousel-inner">
                                <div class="peopel-item item active"><p class="peopel-comment">" Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. "</p>
                                    ...
                                    <div class="group-peole-info">
                                        ...
                                        <div class="people-job">Student(T.Y.BCOM)</div>
                                    </div>
                                </div>
                                <div class="peopel-item item"><p class="peopel-comment">" Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. "</p>

                                    <div class="group-peole-info">
                                        <div class="peopel-avatar"><img src="assets/images/people-avatar-1.jpg" alt="" class="img-responsive"/></div>
                                        <div class="peopel-name">john doe</div>
                                        <div class="people-job">Student(M.Com Part I)</div>
                                    </div>
                                </div>
...
<div class="theme-setting">
    ...
    <a href="contact.php" class="btn-theme-setting">Demo Lecture</a>
</div>
<!-- LOADING-->
...
<script>
    ...
    {
        $('.logo .header-logo img').attr('src', 'images/logo.png');
    } 
    else if ((Cookies.get('color-skin') == undefined) || (Cookies.get('color-skin') == 'color-1')) 
    {
        $('.logo .header-logo img').attr('src', 'images/logo.png');

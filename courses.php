...
<head><title>Shree Commerce Classes | Courses</title>
    <meta charset="utf-8">
            ...
            <div class="header-main-wrapper">
                ...
                <nav class="navigation collapse navbar-collapse pull-right">
                    <ul class="nav-links nav navbar-nav">
                        ...
                        <li class="dropdown active"><a href="courses.php" class="main-menu">Courses</a>
                        </li>
    ...
    <div id="page-wrapper"><!-- MAIN CONTENT-->
        <div class="main-content"><!-- CONTENT-->
            <div class="content">
                ...
                <div class="section section-padding courses bg-gray">
                    <div class="container">
                                ...
                                <div id="campus" role="tabpanel" class="tab-pane fade in active">
                                    <div class="style-show style-grid row">
                                        ...
                                        <div class="col-style">
                                            <div class="edugate-layout-2">
                                                <div class="edugate-layout-2-wrapper">
                                                    <div class="edugate-content"><a class="title">B.F.M</a>
                                                        <div class="description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
                                                    </div>
...
<!-- Mirrored from swlabs.co/edugate/courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Nov 2018 04:29:40 GMT -->
</html>